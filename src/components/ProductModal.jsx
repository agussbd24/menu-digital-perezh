  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/80 p-0 backdrop-blur-md sm:items-center sm:p-4 animate-fade-in">
      ...
      >
        ...
        <div className="shrink-0 border-t border-white/[0.08] bg-perez-navy/95 backdrop-blur-xl px-4 py-4 sm:px-6 sm:py-6 space-y-3 sm:space-y-0 sm:flex sm:items-center sm:gap-4" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom, 0px))' }}>
          {/* Quantity Selector */}
